...
function WritingListView({
    ...
    async function deleteWriting(w: WritingApiDto) {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL_DEV}/Api/Writing/Delete/${w.writingId}`, {
                method: "DELETE",
                credentials: "include",
            });
            if (!res.ok) {
...
export default function WritingEditBuilder({ onBack }: Props) {
    ...
    useEffect(() => {
        fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL_DEV}/Api/Writing/GetAll`, { credentials: "include" })
    ...
    async function handleSelect(w: WritingApiDto) {
        ...
        setSelectError("");
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL_DEV}/Api/Writing/Get/${w.writingId}`, { credentials: "include" });
