        ...
        fetch("${process.env.BACKEND_URL_DEV}/Api/Config/GetConfig", { credentials: "include" })
            ...
            .then((data) => {
                ...
                applyVars({
                    ...
                    "--cms-faq-bg": home?.faqBackgroundColour,
                    "--cms-faq-heading": home?.faqHeadingTextColour,
                    "--cms-faq-body": home?.faqParagraphTextColour,
                    "--cms-faq-card-bg": home?.faqCardsBackgroundColour,
